        ...
        {productData.map(({id,
            ...
            <div key={id} className="w-full bg-white text-black p-4 border-gray-300 rounded-lg group overflow-hidden">
                <div className="w-full h-[320px] relative">
                    ...
                    transition-transform duration-300" width={300} height={300} src={image} alt="productImage"/>
                    <div  className="w-12 h-12 absolute bottom-20 right-0 border-[1px] border-gray-400 bg-white rounded-md flex flex-col translate-x-20 group-hover:translate-x-0
                ...
                <p className="flex items-center">
                    ...
                    text-white rounded-md hover:bg-amazon_yellow hover:text-black
                    duration-300 mt-2">
                        Add to Cart</button>
                </div>
            </div>
